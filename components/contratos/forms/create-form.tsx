...
import { addContrato } from "@/actions/contrato-actions"
...
export function CreateForm() {
  ...
  const empresas = listEmpresas?.map(empresa => ({
    label: empresa.nombre, // Reemplaza 'nombre' con el campo real de nombre de tu empresa
    value: empresa.id, // Reemplaza 'id' con el campo real de id de tu empresa
  })) || []
