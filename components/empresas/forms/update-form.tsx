...
import { getEmpresa, updateEmpresa } from "@/actions/empresa-actions"
...
interface Props {
    empresaToUpdate: Empresa | null
    id: string
}

export function UpdateForm({ empresaToUpdate, id }: Props) {
    const form = useForm<empresaFormValues>({
        resolver: zodResolver(empresaFormSchema),
        defaultValues: {
            nombre: empresaToUpdate?.nombre,
            nit: empresaToUpdate?.nit,
            pais: empresaToUpdate?.pais,
            departamento: empresaToUpdate?.departamento,
            ciudad: empresaToUpdate?.ciudad,
            direccion: empresaToUpdate?.direccion,
            telefono: empresaToUpdate?.telefono,
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                            placeholder="Nombre"
                                            {...field}
                                            defaultValue={empresaToUpdate?.nombre}
                                        />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input type="number"
                                            ...
                                            {...field}
                                            defaultValue={empresaToUpdate?.telefono}
                                        />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <Input
                                    ...
                                    {...field}
                                    defaultValue={empresaToUpdate?.direccion}
                                />
                            </FormControl>
                            <FormDescription>
