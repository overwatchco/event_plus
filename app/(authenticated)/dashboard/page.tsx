import { BasicDashboardCard, UsersDashboardCard } from "@/components"
    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          {/* Card para mostrar la informacion de la empresa */}
          <BasicDashboardCard
            titulo={"Empresa"}
            detalles={{ nit: '102131', telefono: 32132, correo: 'empresa@example.com' }}
            path="/empresa">
          </BasicDashboardCard>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <h1 className="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2">Contratos</h1>
